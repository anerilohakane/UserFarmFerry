          ...
          >
            ...
            <View className="relative">
              ...
              {hasDiscount && discountPercentage > 0 && (
                <LinearGradient
                  ...
                  className="absolute top-2 left-12 rounded-full px-2 py-1"
                >
              ...
              {/* Status Badges */}
              {isOutOfStock ? (
                <View className="absolute bottom-2 left-2 bg-red-600/95 rounded-full px-3 py-1.5">
                  <Text className="text-white text-xs font-semibold">Out of Stock</Text>
                </View>
              ) : isLowStock ? (
                <View className="absolute bottom-2 right-2 bg-amber-500/95 rounded-full px-2 py-1">
                  <Text className="text-white text-xs font-semibold">Only {item.stockQuantity} left</Text>
                </View>
              ) : null}
            </View>
            ...
            <View className="p-3">
                ...
                <View className="flex-row items-center">
                  {hasDiscount ? (
                    <>
                      ...
                      <View className="ml-2 bg-red-50 rounded px-1.5 py-0.5">
              ...
              <View className="flex-row gap-2">
                <TouchableOpacity
                  onPress={() => handleAddToCart(item)}
                  className="flex-1 rounded-lg py-2.5 flex-row items-center justify-center shadow-sm"
                  style={{
                    backgroundColor: isOutOfStock ? '#9CA3AF' : '#16A34A',
                    shadowColor: '#000',
                    shadowOffset: { width: 0, height: 1 },
                    shadowOpacity: 0.1,
                    shadowRadius: 2,
  ...
  const renderEmpty = () => (
    <View className="flex-1 justify-center items-center px-8" style={{ minHeight: height * 0.6 }}>
      ...
      <View className="mb-6">
        ...
        >
          <Heart size={52} color="#16A34A" fill="#16A34A" />
        </LinearGradient>
      </View>
          ...
          >
            ...
            <View className="flex-row justify-end space-x-3">
              ...
              <TouchableOpacity
                onPress={modalConfig.onConfirm}
                className={`px-5 py-3 rounded-lg ${
                  modalConfig.confirmText === "Remove" 
                    ? "bg-red-500" 
                    : "bg-green-600"
                }`}
              >
